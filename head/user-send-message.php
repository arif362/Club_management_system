...
if(isset($_REQUEST['c_id'])) 
{
	...
	$statement = $db->prepare("DELETE FROM tbl_message WHERE c_id=?");
...
<table class="tbl2" width="100%">
	...
	include("../config.php");
	$i=0;
	$statement = $db->prepare("SELECT * FROM tbl_message  ORDER BY c_id DESC");
	$statement->execute();
	...
	foreach($result as $row)
	{
		...
		<tr>
			...
			&nbsp;|&nbsp;
			<a onclick='return confirmDelete();' href="user-send-message.php?c_id=<?php echo $row['c_id']; ?>">Delete</a></td>
