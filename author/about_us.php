			...
			<div class="slider_part"><!--Start Slider Part-->
				...
				<div id="ninja-slider">
					<ul>
						...
						<li><div data-image="slider/img/2-s.jpg"><h3>Department of Computer Science & Engineering</h3></div></li>
						...
						<li><div data-image="slider/img/5-s.jpg"><h3>PHP-MYSQL,HTML,CSS,JAVA,C-Programming</h3></div></li>
			...
			<div class="main_body"> <!--Start Main Body-->
				<div class="content_part">
					<div class="left_content">
						...
						<div class="photo_p">
							<img src="images/p-1.jpg" alt="logo">
						
						</div>
						<div class="text_p">
								<p>City University Computer Club (CUCC) is a leading Organization of City University .City University Computer Club City University Computer Club
								(CUCC) is a leading Organization of City University .City University Computer Club (CUCC) is a leading Organization City University Computer Club
								of City University .City University Computer Club (CUCC) is a leading Organization of City University .City University Computer Club
								City University Computer ClubCity University Computer ClubCity University Computer ClubCity University Computer Club
								City University Computer ClubCity University Computer ClubCity University Computer ClubCity University Computer ClubCity University Computer Club</p>							
					...
					<div class="president1">
						<h2>Message From Vice-President</h2>
						<div class="photo_p">
							<img src="images/33.jpg" alt="logo">
						
						</div>
						<div class="text_p">
								<p>City University Computer Club (CUCC) is a leading Organization of City University .City University Computer Club (CUCC) is a leading Organization of City University .City University Computer Club (CUCC) is a leading Organization of City University .City University Computer Club (CUCC) is a leading Organization of City University .</p>							
					...
					<div class="notice">
						...
						<div class="text_1">
								<h2>Notice Board</h2>
								<p>City University Computer Club (CUCC) is a leading Organization of City University . </p>
								<a href=""><p>Read More</p></a>
					</div>
					...
					<div class="campus">
						<div class="photo_2">
							<img src="images/campus.jpg" alt="logo">
